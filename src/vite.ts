...
import {createLogger, PluginOption} from "vite";
    ...
    config() {
      ...
      if (!fs.existsSync(langDirname)) {
        const msg = [
          ...
          'For more information please visit: https://laravel.com/docs/12.x/localization#publishing-the-language-files'
        ];
      ...
      if (phpLocales.length > 0) {
        ...
        const msg = [
          ...
          'For more information please visit: https://laravel.com/docs/12.x/localization#introduction'
        ];
